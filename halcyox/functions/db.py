import sqlite3 # we are using a local database
# TODO, convert this to a cloud based database server and add storage buckets for videos and convos
...
def save_character_schema(characterSchema):
    """Save a new character schema to the database"""
